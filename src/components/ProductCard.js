    ...
    render: ({id, name,url_image, price, discount, category }) => {
        ...
        return `
            <li class="shadow-md p-3 border border-gray-300">
                <img src="${url_image && url_image != '' ? url_image : 'http://owen.tuzitio.com/assets/camaleon_cms/image-not-found-4a963b95bf081c3ea02923dceaeb3f8085e1a654fc54840aac61a57a60903fef.png'}" alt="${name}" />
